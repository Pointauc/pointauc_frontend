...
export const donateHelperControllerAuthorizeQueryKey = (options: Options<DonateHelperControllerAuthorizeData>) => createQueryKey('donateHelperControllerAuthorize', options);
 ...
 */
export const donateHelperControllerAuthorizeOptions = (options: Options<DonateHelperControllerAuthorizeData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await donateHelperControllerAuthorize({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: donateHelperControllerAuthorizeQueryKey(options)
    });
};
 ...
 * Processes Donate Helper API key and links the Donate Helper account to the user session. Returns whether this is a new user registration.
 */
export const donateHelperControllerAuthorizeMutation = (options?: Partial<Options<DonateHelperControllerAuthorizeData>>): UseMutationOptions<DonateHelperControllerAuthorizeResponse, AxiosError<DefaultError>, Options<DonateHelperControllerAuthorizeData>> => {
    const mutationOptions: UseMutationOptions<DonateHelperControllerAuthorizeResponse, AxiosError<DefaultError>, Options<DonateHelperControllerAuthorizeData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await donateHelperControllerAuthorize({
                ...options,
                ...localOptions,
...
export const donateHelperControllerRevokeQueryKey = (options?: Options<DonateHelperControllerRevokeData>) => createQueryKey('donateHelperControllerRevoke', options);
 ...
 */
export const donateHelperControllerRevokeOptions = (options?: Options<DonateHelperControllerRevokeData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await donateHelperControllerRevoke({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: donateHelperControllerRevokeQueryKey(options)
    });
};
 ...
 * Invalidates and removes Donate Helper integration for the authenticated user. Requires authentication via cookie.
 */
export const donateHelperControllerRevokeMutation = (options?: Partial<Options<DonateHelperControllerRevokeData>>): UseMutationOptions<unknown, AxiosError<DefaultError>, Options<DonateHelperControllerRevokeData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<DefaultError>, Options<DonateHelperControllerRevokeData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await donateHelperControllerRevoke({
                ...options,
                ...localOptions,
