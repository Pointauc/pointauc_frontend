...
export const twitchWebhookControllerNotificationQueryKey = (options?: Options<TwitchWebhookControllerNotificationData>) => createQueryKey('twitchWebhookControllerNotification', options);

export const twitchWebhookControllerNotificationOptions = (options?: Options<TwitchWebhookControllerNotificationData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await twitchWebhookControllerNotification({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: twitchWebhookControllerNotificationQueryKey(options)
    });
};

export const twitchWebhookControllerNotificationMutation = (options?: Partial<Options<TwitchWebhookControllerNotificationData>>): UseMutationOptions<unknown, AxiosError<DefaultError>, Options<TwitchWebhookControllerNotificationData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<DefaultError>, Options<TwitchWebhookControllerNotificationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await twitchWebhookControllerNotification({
                ...options,
                ...localOptions,
...
export const broadcastingControllerBroadcastSettingsQueryKey = (options: Options<BroadcastingControllerBroadcastSettingsData>) => createQueryKey('broadcastingControllerBroadcastSettings', options);

export const broadcastingControllerBroadcastSettingsOptions = (options: Options<BroadcastingControllerBroadcastSettingsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await broadcastingControllerBroadcastSettings({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: broadcastingControllerBroadcastSettingsQueryKey(options)
    });
};

export const broadcastingControllerBroadcastSettingsMutation = (options?: Partial<Options<BroadcastingControllerBroadcastSettingsData>>): UseMutationOptions<unknown, AxiosError<DefaultError>, Options<BroadcastingControllerBroadcastSettingsData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<DefaultError>, Options<BroadcastingControllerBroadcastSettingsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await broadcastingControllerBroadcastSettings({
                ...options,
                ...localOptions,
