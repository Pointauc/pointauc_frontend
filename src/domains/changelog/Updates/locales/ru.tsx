...
export const ChangesRU: UpdateData[] = [
  ...
  },
  {
    ...
    newFeatures: [
      {
        briefDescription: 'Новая страница с историй аукционов',
        content: (
          <>
            <strong>Страница истории всех прошлых аукционов</strong>
            <Space h='sm' />
            <div>
              Добавлена новая страница, где можно смотреть данные прошлых аукционов в одном месте а также статистику
              активности зрителей.
            </div>
          </>
        ),
      ...
      {
        briefDescription: 'Новая опция для отображения имён зрителей в таблице',
        content: (
          <>
            <strong>Имена зрителей в лотах</strong>
            <Space h='sm' />
            <div>
              Добавлена новая опция, которая показывает имена зрителей прямо в лотах аукциона. Ее можно активировать на
              странице настроек в разделе "Внешний вид".
            </div>
          </>
        ),
      },
