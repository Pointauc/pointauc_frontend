...
interface DefaultWheelPointerProps {
  size: number;
  idPrefix: string;
}

const DefaultWheelPointer = ({ size, idPrefix }: DefaultWheelPointerProps) => {
  ...
  return (
    <svg className={classes.wheelPointer} width={size} height={size} viewBox='0 0 160 160' aria-hidden='true'>
      <defs>
      ...
      <path
        d='M80 17L100 31L109 46L100 61L95 83L89 102L80 129L71 102L65 83L60 61L51 46L60 31L80 17Z'
        fill='#5B1111'
      />
      ...
      {/* <path d='M69 45L80 39L91 45L80 50L69 45Z' fill='rgba(255, 244, 245, 0.72)' /> */}
...
export default DefaultWheelPointer;
