...
const DuplicateTitleErrorModalContent = () => {
  ...
  return (
    <Stack gap='sm'>
      <Text>{t('integration.twitch.connectionError.duplicateTitle.description')}</Text>
      <Text c='dimmed' size='sm'>
        <Trans
          i18nKey='integration.twitch.connectionError.duplicateTitle.fix'
          components={{
...
export default DuplicateTitleErrorModalContent;
