...
const DropoutWheelProof: FC = () => {
  ...
  return (
    <div className="dropout-wheel-proof">
      <h2>Кратко</h2>
      <p>
        Шансы на победу у лотов ТАКОЙ ЖЕ как если бы вы крутили обычное колесо. Но есть неочевидный нюанс, чем больше
        лотов в колесе, тем более равные шансы на выбывание будет у лотов, и чем меньше лотов осталось, тем меньше
        шансов выбыть у дорогих лотов. Это бывает очень не очевидно для зрителей, но именно с такой инверссией это
        колесо полностью честное (все равно как крутить обычное колесо по шансам).
      </p>
      <p>
      ...
      <div>Формула для расчета инвертированного размера (написано от руки, делать для этого ui долго):</div>
      ...
      <p>
        ...
        эту формулу симуляцией и она идеально соответствует шансам в обычном колесе.
      </p>
      ...
      <p>
        В любом случае пока это лучшее, что я придумал. Я даже денег за сайт не беру, а такие комментарии немного
        обидны. По большому счету мне конечно поебать, но все же.
      </p>
    </div>
  );
};
