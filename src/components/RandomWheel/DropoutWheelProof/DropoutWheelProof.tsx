...
const DropoutWheelProof: FC = () => {
  ...
  return (
    <div className="dropout-wheel-proof">
      <h2>Кратко</h2>
      <p>
        Шансы на победу у лотов ТАКОЙ ЖЕ как если бы вы крутили обычное колесо. Но есть не очевидный нюанс, чем больше лотов в
        колесе, тем более равные шансы на выбывание будет у лотов, и чем меньше лотов осталось, тем меньше шансов выбыть
        у дорогих лотов. Это бывает очень не очевидно для зрителей, но именно с такой инверссией это колесо полностью
        честное (все равно как крутить обычное колесо по шансам).
      </p>
      <p>
