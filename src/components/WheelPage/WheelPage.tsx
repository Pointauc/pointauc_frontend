...
const WheelPage: FC = () => {
  ...
  const wheelItems = useMemo(() => {
    const splittedItems: Slot[] = rawItems.reduce<any>((acc, { amount, ...slot }) => {
    ...
    const items = splittedItems.map<WheelItem>(({ id, name, amount }) => ({
      id: id.toString(),
      name: name || '',
      size: Number(amount),
      color: getWheelColor(),
  ...
  return (
    <PageContainer title="Колесо">
      ...
      <div className="wheel-controls">
        ...
        <div className="wheel-controls-row">
          <Typography className="wheel-controls-tip md">Макс. стоимость</Typography>
          <Slider
        ...
        <div className="wheel-controls-row">
          <Typography>Случайный темп вращения</Typography>
